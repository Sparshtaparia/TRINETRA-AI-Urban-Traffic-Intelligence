      ...
      <main className="flex-1 flex flex-col p-6 min-h-0 overflow-y-auto">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <TabsContent value="map-view" keepMounted className={`mt-0 border-0 p-0 flex-col flex-1 h-full min-h-0 data-[state=active]:flex ${activeTab === "map-view" ? "flex" : "hidden"}`}>
